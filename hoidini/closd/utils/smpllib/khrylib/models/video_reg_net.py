...
from hoidini.closd.utils.smpllib.khrylib.models.resnet import ResNet
...
from hoidini.closd.utils.smpllib.khrylib.models.mlp import MLP
from hoidini.closd.utils.smpllib.khrylib.models.mobile_net import MobileNet
...
class VideoRegNet(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.cnn is not None:
            x = self.cnn(x.view((-1,) + self.frame_shape)).view(
                -1, x.size(1), self.cnn_fdim
            )
