...
from hoidini.closd.utils.smpllib.utils.image_utils import write_frames_to_video
from hoidini.closd.utils.smpllib.khrylib.utils import (
    get_body_qposaddr,
    get_body_qveladdr,
)
...
from hoidini.closd.utils.smpllib.smpllib.smpl_parser import SMPL_Parser

from hoidini.closd.utils.smpllib.utils.torch_geometry_transforms import (
    angle_axis_to_rotation_matrix,
    rotation_matrix_to_quaternion,
)
from hoidini.closd.utils.smpllib.utils.transform_utils import (
...
import hoidini.closd.utils.smpllib.utils.rotation_conversions as tR
...
def smpl_to_qpose_torch(
    ...
    curr_spose = tR.matrix_to_euler_angles(
        curr_pose_mat[:, :, :3, :3], convention=euler_order
    )
    curr_spose = curr_spose.reshape(-1, num_joints, 4 if use_quat else 3)[
        :, smpl_2_mujoco, :
    ].reshape(-1, num_angles)
...
def qpos_to_smpl(qpos, mj_model, smpl_model="smpl"):
    ...
    smpl_bones_to_use = (
        SMPL_BONE_ORDER_NAMES if smpl_model == "smpl" else SMPLH_BONE_ORDER_NAMES
    )
