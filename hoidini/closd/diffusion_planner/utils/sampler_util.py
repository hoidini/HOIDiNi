...
from hoidini.closd.diffusion_planner.utils.misc import wrapped_getattr
import joblib
...
class ClassifierFreeSampleModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None):
        ...
        # y_uncond = deepcopy(y)  # (Roey) enable gradient propagation by shallow copy instead of deep
