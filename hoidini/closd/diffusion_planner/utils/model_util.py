...
from hoidini.closd.diffusion_planner.model.mdm import MDM
from hoidini.closd.diffusion_planner.diffusion import gaussian_diffusion as gd
from hoidini.closd.diffusion_planner.diffusion.respace import (
    SpacedDiffusion,
    space_timesteps,
)
from hoidini.closd.diffusion_planner.utils.parser_util import get_cond_mode
...
def create_model_and_diffusion(args, n_feats):
    model = MDM(**get_model_args(args, n_feats))
    diffusion = create_gaussian_diffusion(args)
    return model, diffusion


def get_model_args(args, n_feats):
    ...
    return {
        ...
        "use_obj_encoder": getattr(args, "use_obj_encoder", False),
    }


def create_gaussian_diffusion(args, classifier_guidance_n_steps: Optional[int] = None):
    # default params
    ...
    if classifier_guidance_n_steps is not None:
        rescale_timesteps = True
        steps = classifier_guidance_n_steps
