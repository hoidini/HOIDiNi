...
@dataclass
class ContactData:
    contact_locs: Tensor  # (B, seq_len, n_anchors, 3)
...
class CPDM(nn.Module):
    def __init__(self, pred_len, context_len, n_feats, num_layers, cond_mask_prob):
        ...
        self.emb_trans_dec = False  # TODO: delete
        self.is_prefix_comp = True  # TODO: delete
        self.emb_policy = "concat"  # TODO: delete
        self.mask_frames = True  # TODO: delete
        ...
        # self.table_type_embedding = nn.Parameter(0.1 * torch.randn(self.latent_dim))
    ...
    def forward(self, x, timesteps, y) -> Tensor:
        ...
        ##################################
        # table_emb = self.table_encoder(y['table_height'])  # (bs, 1)
        ...
        cond_emb = torch.cat(
            [time_emb, obj_emb, text_emb], dim=0
        ...
        cond_mask = torch.cat(
            [mask_time, mask_obj, mask_text], dim=1
